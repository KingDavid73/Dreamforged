...
for _,key in ipairs({'showTargetCard','directorVoiceFrequency','directorDebugView','inventoryKey','forgeKey','abilityControllerModifier','abilityControllerCycle','abilityControllerUse'}) do keyGroups[key]=groupKeys.interface end
...
local defaults = {
    ...
    showTargetCard = true, directorVoiceFrequency = 60, directorDebugView = false, inventoryKey = 'F8', forgeKey = 'F7', pageSize = 4, maxGeneratedItems = 2000,
