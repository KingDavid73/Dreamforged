...
local groups={
    ...
    {key=C.groups.encounters,name='encounterSettings',description='encounterSettingsDescription',order=30,settings={
        ...
        option('exteriorBudget', 'number', {min=0,max=16,integer=true}),
        option('exteriorTriggerMin', 'number', {min=100,max=2000,integer=true}),
        option('exteriorTriggerRange', 'number', {min=600,max=8000,integer=true}),
        option('exteriorAnchorChance', 'number', {min=0,max=100,integer=true}),
        option('exteriorGroupMin', 'number', {min=1,max=10,integer=true}),
        option('exteriorGroupMax', 'number', {min=1,max=10,integer=true}),
        option('exteriorSpawnMin', 'number', {min=100,max=3000,integer=true}),
